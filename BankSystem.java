...
public class BankSystem {
    public void Withdraw(AccountTypes user) {
    ...
    public void Deposit(AccountTypes user) {
        Scanner input = new Scanner(System.in);
    ...
    public void CheckBalance(AccountTypes user) {
        Scanner input = new Scanner(System.in);
    ...
    public void predictInterest(AccountTypes user) {
        Scanner input = new Scanner(System.in);
